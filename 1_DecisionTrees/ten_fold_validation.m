...
for i = 1:9
    ...
    test_results((i-1)*100+1:i*100,:) = classify(emotion_decision_trees',  test_examples, strategy);
    ...
    test_results(901:length(examples),:) = classify(emotion_decision_trees',  test_examples, strategy);
